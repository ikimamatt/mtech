        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('laptops.update', ['laptop' => $laptop]) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label for="select-region" class="form-label">Laptop</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                value="{{ old('name', $laptop->name) }}" id="inputNamaLaptop" placeholder="Nama Laptop">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('spesification') is-invalid @enderror" name="spesification"
                                id="InputSpesifikasi" placeholder="Spesifikasi Laptop" rows="3" value="{{ old('spesification') }}">{{ $laptop->spesification }}</textarea>
                            @error('spesification')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('user_name') is-invalid @enderror"
                                ...
                                value="{{ old('user_name', $laptop->user_name) }}">
                            @error('user_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ip_address') is-invalid @enderror"
                                ...
                                value="{{ old('ip_address', $laptop->ip_address) }}">
                            @error('ip_address')
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-region" name="kd_region"
                                ...
                                @foreach ($regions as $region)
                                    <option value="{{ $region->kd_region }}" @selected($region->kd_region==$laptop->kd_region)>
                                        {{ $region->nama_region }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-region-ownership" name="ownership_status"
                                ...
                                <option value="Aset PLN" {{ $laptop->ownership_status === 'Aset PLN' ? 'selected' : '' }}>
                                    Aset PLN</option>
                                <option value="Sewa" {{ $laptop->ownership_status === 'Sewa' ? 'selected' : '' }}>Sewa
                                </option>
                            </select>
                        ...
                        <div class="mb-3" id="vendor-select-container">
                            ...
                            <select id="select-region-vendor" name="vendor"
                                ...
                                <option value="Aset PLN"
                                    {{ old('ownership_status', $laptop->ownership_status) === 'Sewa' ? 'selected' : '' }}>
                                    -- Pilih Vendor --
                                </option>
                                @foreach ($vendors as $vendor)
                                    <option value="{{ $vendor->name }}"
                                        {{ old('vendor', $laptop->vendor) === $vendor->name ? 'selected' : '' }}>
                                        {{ $vendor->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('year') is-invalid @enderror" name="year"
                                id="inputYear" placeholder="Tahun" value="{{ old('year', $laptop->year) }}"
                                min="2000" max="{{ date('Y') }}">
                            @error('year')
                                <label for="select-region" class="error mt-1 tx-13 text-danger">{{ $message }}</label>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('tanggal_pembelian') is-invalid @enderror"
                                name="tanggal_pembelian" id="inputTanggalPembelian" placeholder="Tahun"
                                value="{{ old('tanggal_pembelian', $laptop->tanggal_pembelian) }}" min="2000" max="{{ date('Y') }}">
                            @error('tanggal_pembelian')
                                <label for="inputTanggalPembelian"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('barcode') is-invalid @enderror"
                                ...
                                value="{{ old('barcode',$laptop->barcode) }}">
                            @error('barcode')
                        ...
                        <div class="mb-3" id="pegawai-select-container">
                            ...
                            <select id="select-pegawai" name="pegawai"
                                ...
                                @foreach ($users as $user)
                                    <option value="{{ $user->id }}" @selected($user->id==$laptop->pegawai)>{{ $user->name }}</option>
                                @endforeach
                            </select>
                            @error('pegawai')
