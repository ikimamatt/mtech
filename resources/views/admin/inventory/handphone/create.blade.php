...
@section('content')
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('handphone.index') }}">Inventory (Handphone)</a></li>
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('handphone.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf

                        <div class="mb-3">
                            <label for="select-region-brand" class="form-label">Merk Handphone</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('serial_number') is-invalid @enderror"
                                name="serial_number" id="input_serial_number" placeholder="serial number"
                        ...
                        <div class="mb-3">
                            <label for="input_nama_pegawai" class="form-label">Nama Pegawai</label>
                            <input type="text" class="form-control @error('nama_pegawai') is-invalid @enderror"
                                name="nama_pegawai" id="input_nama_pegawai" placeholder="Nama Pegawai"
