...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Tambah Server</h6>
                    <form class="forms-sample" action="{{ route('servers.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select id="brand_id" name="brand_id"
                                ...
                                <option value="" disabled selected>Pilih Merk Sever</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ip_address') is-invalid @enderror"
                                name="ip_address" id="ip_address" placeholder="IP Adress"
