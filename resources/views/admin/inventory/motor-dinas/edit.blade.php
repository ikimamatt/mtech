        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('motor-dinas.update', ['motor_dina' => $motorDinas->id]) }}"
                        method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label for="select-region" class="form-label">Merk Motor Dinas</label>
                            <select id="select-region" name="brand_id"
                                class="form-select @error('brand_id') is-invalid @enderror" data-width="100%">
                                <option value="">-- Pilih Merek --</option>
                                @foreach ($brands as $brand)
                                    <option value="{{ $brand->id }}"
                                        {{ old('id', $brand->id) == $motorDinas->brand_id ? 'selected' : '' }}>
                                        {{ $brand->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor_polisi') is-invalid @enderror"
                                ...
                                value="{{ old('nomor_polisi', $motorDinas->nomor_polisi) }}">
                            @error('nomor_polisi')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor_rangka') is-invalid @enderror"
                                ...
                                value="{{ old('nomor_rangka', $motorDinas->nomor_rangka) }}">
                            @error('nomor_rangka')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nomor_mesin') is-invalid @enderror"
                                ...
                                value="{{ old('nomor_mesin', $motorDinas->nomor_mesin) }}">
                            @error('nomor_mesin')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('model') is-invalid @enderror" name="model"
                                id="inputModel" placeholder="Serial Number" value="{{ old('model', $motorDinas->model) }}">
                            @error('model')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tahun_pembuatan') is-invalid @enderror"
                                ...
                                value="{{ old('tahun_pembuatan', $motorDinas->tahun_pembuatan) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('warna') is-invalid @enderror"
                                ...
                                value="{{ old('warna', $motorDinas->warna) }}">
                            @error('warna')
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-region" name="kd_region"
                                ...
                                @foreach ($regions as $region)
                                    <option value="{{ $region->kd_region }}" @selected($region->kd_region == $motorDinas->kd_region)>
                                        {{ $region->nama_region }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-region-ownership" name="status_asset"
                                ...
                                <option value="Aset PLN" {{ $motorDinas->status_asset === 'Aset PLN' ? 'selected' : '' }}>
                                    Aset PLN</option>
                                <option value="Sewa" {{ $motorDinas->status_asset === 'Sewa' ? 'selected' : '' }}>Sewa
                                </option>
                            </select>
                            @error('status_asset')
                                <label for="select-region" class="error mt-1 tx-13 text-danger">{{ $message }}</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('keterangan') is-invalid @enderror" name="keterangan"
                                id="InputKeterangan" placeholder="" rows="3">{{ old('keterangan', $motorDinas->keterangan) }}</textarea>
                            @error('keterangan')
                        ...
                        <a href="{{ route('motor-dinas.index') }}" class="btn btn-secondary" type="reset">Cancel</a>
