        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('computers.update', ['computer' => $computer]) }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="inputNamaLaptop" placeholder="Nama Komputer" value="{{ old('name', $computer->name) }}">
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea type="text" class="form-control @error('spesification') is-invalid @enderror" name="spesification"
                                id="InputSpesifikasi" placeholder="Spesifikasi Komputer" rows="3"
                                value="{{ old('spesification', $computer->spesification) }}">{{ $computer->spesification }}</textarea>
                            @error('spesification')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('user_name') is-invalid @enderror"
                                ...
                                value="{{ old('user_name', $computer->user_name) }}">
                            @error('user_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ip_address') is-invalid @enderror"
                                ...
                                value="{{ old('ip_address', $computer->ip_address) }}">
                            @error('ip_address')
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-region" name="kd_region"
                                ...
                                @foreach ($regions as $region)
                                    <option value="{{ $region->kd_region }}" @selected($region->kd_region == $computer->kd_region)>
                                        {{ $region->nama_region }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-region-ownership" name="ownership_status"
                                ...
                                <option value="Aset PLN"
                                    {{ $computer->ownership_status === 'Aset PLN' ? 'selected' : '' }}>Aset PLN</option>
                                <option value="Sewa" {{ $computer->ownership_status === 'Sewa' ? 'selected' : '' }}>Sewa
                                </option>
                            </select>
                        ...
                        <div class="mb-3" id="vendor-select-container">
                            ...
                            <select id="select-region-vendor" name="vendor"
                                ...
                                <option value="Aset PLN"
                                    {{ old('ownership_status', $computer->ownership_status) === 'Sewa' ? 'selected' : '' }}>
                                    -- Pilih Vendor --
                                </option>
                                @foreach ($vendors as $vendor)
                                    <option value="{{ $vendor->name }}"
                                        {{ old('vendor', $computer->vendor) === $vendor->name ? 'selected' : '' }}>
                                        {{ $vendor->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('year') is-invalid @enderror" name="year"
                                id="inputYear" placeholder="Tahun" value="{{ old('year', $computer->year) }}"
                                min="2000" max="{{ date('Y') }}">
                            @error('year')
                                <label for="select-region" class="error mt-1 tx-13 text-danger">{{ $message }}</label>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('office') is-invalid @enderror"
                                name="office" id="inputOffice" placeholder="Nama Kantor"
                                value="{{ old('office', $computer->office) }}">
                            @error('office')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('system_operation') is-invalid @enderror"
                                ...
                                value="{{ old('system_operation', $computer->system_operation) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('kes') is-invalid @enderror" name="kes"
                                id="inputkes" placeholder="Nama KES" value="{{ old('kes', $computer->kes) }}">
                            @error('kes')
                                <label for="inputNamaPengguna"
                                    class="error mt-1 tx-13 text-danger">{{ $message }}</label>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('mouse') is-invalid @enderror"
                                name="mouse" id="inputMouse" placeholder="Nama mouse"
                                value="{{ old('mouse', $computer->mouse) }}">
                            @error('mouse')
                                <label for="inputNamaPengguna"
                                    class="error mt-1 tx-13 text-danger">{{ $message }}</label>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-jd" name="status_id"
                                ...
                                <option value="">-- Pilih Status --</option>
                                <option value="1" {{ $computer->status_id === 1 ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ $computer->status_id === 0 ? 'selected' : '' }}>Tidak</option>
                            </select>
                            @error('status_id')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('rental_price') is-invalid @enderror"
                                ...
                                value="{{ old('rental_price', $computer->rental_price) }}">
                            @error('rental_price')
                                <label for="inputNamaPengguna"
                                    class="error mt-1 tx-13 text-danger">{{ $message }}</label>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('contract_date') is-invalid @enderror"
                                name="contract_date" id="inputKeyboard" placeholder="Nama keyboard"
                                value="{{ old('contract_date', $computer->contract_date) }}">
                            @error('contract_date')
                                <label for="inputNamaPengguna"
                                    class="error mt-1 tx-13 text-danger">{{ $message }}</label>
                            @enderror
