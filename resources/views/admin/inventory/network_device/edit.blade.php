...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Ubah Network Device</h6>
                    <form class="forms-sample"
                        action="{{ route('network-devices.update', ['network_device' => $network_device]) }}"
                        method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <select id="brand_id" name="brand_id"
                                ...
                                <option value="" disabled>-- Pilih Merk Network Device --</option>
                                @foreach ($brands as $brand)
                                    <option value="{{ $brand->id }}"
                                        {{ old('brand_id', $network_device->brand_id) == $brand->id ? 'selected' : '' }}>
                                        {{ $brand->name }}</option>
                                @endforeach
                            </select>
                            @error('brand_id')
                        ...
                        <div class="mb-3">
                            <label for="device_type" class="form-label">Keterangan</label>
                            <input type="text" class="form-control @error('device_type') is-invalid @enderror"
                                ...
                                value="{{ old('device_type', $network_device->device_type) }}">
                            @error('device_type')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ip_address') is-invalid @enderror"
                                ...
                                value="{{ old('ip_address', $network_device->ip_address) }}">
                            @error('ip_address')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('user_name') is-invalid @enderror"
                                ...
                                value="{{ old('user_name', $network_device->user_name) }}">
                            @error('user_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('password') is-invalid @enderror"
                                ...
                                value="{{ old('password', $network_device->password) }}">
                            @error('password')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('username') is-invalid @enderror"
                                ...
                                value="{{ old('username', $network_device->username) }}">
                            @error('username')
                            ...
                            <select id="unit_id" name="unit_id" class="form-select @error('unit_id') is-invalid @enderror"
                                ...
                                @foreach ($units as $unit)
                                    <option value="{{ $unit->id }}"
                                        {{ old('unit_id', $network_device->unit_id) == $unit->id ? 'selected' : '' }}>
                                        {{ $unit->nama_unit }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="ownership_status" name="ownership_status"
                                ...
                                <option value="Aset PLN"
                                    {{ old('ownership_status', $network_device->ownership_status) == 'Aset PLN' ? 'selected' : '' }}>
                                    Aset PLN</option>
                                <option value="Sewa"
                                    {{ old('ownership_status', $network_device->ownership_status) == 'Sewa' ? 'selected' : '' }}>
                                    Sewa</option>
                            </select>
                            ...
                            <select id="vendor_id" name="vendor_id"
                                ...
                                @foreach ($vendors as $vendor)
                                    <option value="{{ $vendor->id }}"
                                        {{ old('vendor_id', $network_device->vendor_id) == $vendor->id ? 'selected' : '' }}>
                                        {{ $vendor->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="year" name="year" class="form-select @error('year') is-invalid @enderror"
                                ...
                                @for ($i = date('Y'); $i <= 2030; $i++)
                                    <option value="{{ $i }}"
                                        {{ old('year', $network_device->year) == $i ? 'selected' : '' }}>
                                        {{ $i }}
                                    </option>
                                @endfor
                            </select>
