...
<div class="d-flex align-items-center flex-wrap text-nowrap">
    <a href="{{route('mobil-dinas.create')}}" class="btn btn-info btn-icon-text mb-2 mb-md-0 me-2">
        <i class="btn-icon-prepend" data-feather="plus"></i>
        Tambah Data
    </a>
    <a href="{{ route('mobil-dinas.export.excel', request()->query()) }}" class="btn btn-success btn-icon-text mb-2 mb-md-0 me-2">
        <i class="btn-icon-prepend" data-feather="file-text"></i>
        Export Excel
    </a>
    <a href="{{ route('mobil-dinas.export.pdf', request()->query()) }}" class="btn btn-danger btn-icon-text mb-2 mb-md-0">
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h6 class="card-title">Filter Data Mobil Dinas</h6>
                <form action="{{ route('mobil-dinas.index') }}" method="GET">
                    <div class="row">
                        <div class="col-md-5">
                            <div class="mb-3">
                        ...
                        <div class="col-md-4 align-self-end">
                            <div class="mb-3">
                                ...
                                <a href="{{ route('mobil-dinas.index') }}" class="btn btn-secondary">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
