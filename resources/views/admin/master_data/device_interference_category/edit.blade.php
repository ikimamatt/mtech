...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Ubah Kategori Gangguan Perangkat</h6>
                    <form class="forms-sample" action="{{ route('deviceinterference.update', ['deviceinterference' => $deviceinterference]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                id="inputName" placeholder="name"  value="{{ old('name', $deviceinterference->name) }}">
                            @error('name')
