        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('popicon.update', ['popicon' => $popicon]) }}" method="POST">
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label for="select-region" class="form-label">Service</label>
                            <select id="select-region" id="multiple-select" multiple="multiple" name="service_id[]" class="form-select @error('service_id') is-invalid @enderror" data-width="100%"  >                        
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('pop_icon_name') is-invalid @enderror"
                                name="pop_icon_name" id="inputPopName" placeholder="Nama Pop Icon" value="{{ old('pop_icon_name', $popicon->pop_icon_name) }}">
                            @error('pop_icon_name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('pop_icon_location') is-invalid @enderror"
                                name="pop_icon_location" id="inputNameLocation" placeholder="Nama Pop Location" value="{{ old('pop_icon_location', $popicon->pop_icon_location) }}">
