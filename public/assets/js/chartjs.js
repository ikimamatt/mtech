$(function() {
  ...
  $(document).ready(function () {
    $.ajax({
        url: '/dataChartLaptop', // Sesuaikan dengan URL rute Anda
        method: 'GET',
        success: function (data) {
            ...
            var counts = data.map(function (item) {
                return item.laptop_count;
            });

            var ctx = document.getElementById('chartLaptop').getContext('2d');
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: [
                            ...
                            'rgba(255, 159, 64, 0.6)'
                            // Tambahkan warna lain jika Anda punya lebih banyak brand
                        ],
...
$(document).ready(function () {
  $.ajax({
      url: '/dataChartPrinter', // Sesuaikan dengan URL rute Anda
      method: 'GET',
      success: function (data) {
          var labels = data.map(function (item) {
              return item.brand_name_printer;
          });

          var counts = data.map(function (item) {
              return item.printer_count;
          });

          var ctx = document.getElementById('chartPrinter').getContext('2d');
